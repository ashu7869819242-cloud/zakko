                        ...
                        <>
                            ...
                            {summary && (
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8 animate-fade-in">
                                    {[
                                        { label: "Total Demands", value: summary.totalDemands, icon: "📋", color: "text-blue-400" },
                                        { label: "Unique Users", value: summary.uniqueUsers, icon: "👥", color: "text-purple-400" },
                                        { label: "Top Item", value: summary.topItem, sub: `${summary.topItemQty} units/week`, icon: "🔥", color: "text-gold-400" },
                                        { label: "Peak Day", value: summary.peakDay, sub: `${summary.peakDayQty} units`, icon: "📅", color: "text-emerald-400" },
                                    ].map((c) => (
                                                    ...
                                                    {items.map((item) => (
                                                        <div key={item.itemName} className="flex items-center justify-between py-1.5 px-3 bg-white/5 rounded-xl">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="text-xs text-zayko-500">👥 {item.uniqueUsers} user{item.uniqueUsers !== 1 ? "s" : ""}</span>
                                                            </div>
